...
public class FollowerUserServiceImplTest extends AbcstractServiceTest {

    @Autowired
    private FollowerUserService followerUserService;

    @Autowired
    private FollowRequestUserProducer followRequestUserProducer;

    @Autowired
    private FollowUserProducer followUserProducer;

    @Autowired
    private FollowUserNotificationProducer followUserNotificationProducer;
